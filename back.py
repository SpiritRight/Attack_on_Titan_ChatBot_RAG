...
REPLACEMENTS = {
    # 인물
    "엘런": "에렌 예거", "엘렌": "에렌 예거", "Eren": "에렌 예거",
    "미카사": "미카사 아커만", "Mikasa": "미카사 아커만",
    "리바이": "리바이 아커만", "Levi": "리바이 아커만",
    "아르민": "아르민 알레르토", "Armin": "아르민 알레르토",
    "크리스타": "히스토리아 레이스", "Historia": "히스토리아 레이스",
    "한지": "한지 조에", "Hange": "한지 조에",
    
    # 거인
    "수레 거인": "차력 거인", "Cart Titan": "차력 거인",
    "공격 거인": "진격의 거인", "Attack Titan": "진격의 거인",
    "초대형 거인": "초대형 거인", "Colossal Titan": "초대형 거인",
    "티부르 가문": "타이버 가문", "티부어 가문": "타이버 가문", "티부르" : "타이버",
    "액커맨": "아커만",
...
def get_retriever():
    ...
    retriever = database.as_retriever(search_kwargs={'k': 3})   # k 4->3
    return retriever
